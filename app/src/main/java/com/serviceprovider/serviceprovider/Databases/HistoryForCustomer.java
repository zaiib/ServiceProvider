...
public class HistoryForCustomer extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "Task_History";

    // table name
    private static final String TABLE_USER = "tasks";
    ...
    public HistoryForCustomer(Context context) {
    ...
    public void deleteNote(String KEY_phone) {
        SQLiteDatabase db = this.getWritableDatabase();
        String ID = "id";
        db.delete(TABLE_USER, KEY_DATE + "= ?",
                new String[]{String.valueOf(KEY_phone)});
//        db.close();
    }
